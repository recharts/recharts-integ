...
function shouldParseMultipleReactVersions() {
    ...
    assert.deepStrictEqual(actualArray, expectedArray, "Should parse multiple React versions correctly");
}

if (require.main === module) {
    console.log("Running YarnController tests...");
    try {
        shouldParseMultipleReactVersions();
